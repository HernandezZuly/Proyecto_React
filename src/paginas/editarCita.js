...
const EditarCita = () => {
    ...
    const pacienteIdCita = arreglo[1];
    const doctorIdCita = arreglo[2];
    const fecha_citaCita = arreglo[3];
    const hora_citaCita = arreglo[4];
    const tipo_citaCita = arreglo[5];
    const valor_citaCita = arreglo[6];

    const [cita,setCita] = useState({
        pacienteId: pacienteIdCita,
        doctorId: doctorIdCita,
        fecha_cita: fecha_citaCita,
        hora_cita: hora_citaCita,
        tipo_cita: tipo_citaCita,
        valor_cita: valor_citaCita
    });
    ...
    const editarCita = async () => {
        ...
        const response = await APIInvoke.invokePUT(`/cita/${id}`, data);
        const idCitaEditado = response.cita.id;

        if (idCitaEditado !== id) {
            const msg = "La cita no fue agendada correctamente.";
            Swal({
                title: "Error",
                text: msg,
                icon: "error",
                                ...
                                <div className="row mb-2">
                                    ...
                                    <div className="col-sm-6">
                                        <ol className="breadcrumb float-sm-right">
                                            <li className="breadcrumb-item"><Link to={"/editarcita"}>Editar</Link></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="content">
                                    ...
                                    <div className="card card-primary">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="time" id="hora_cita" name="hora_cita" className="form-control" value={hora_cita} onChange={onChange} required/>
                                            </div>
                                            <div className="form-group">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <Link to={"/cita"} className="btn btn-secondary">Cancelar</Link>
